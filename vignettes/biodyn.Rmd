...
```{rrefFMSY,eval=FALSE,fig.fullwidth=TRUE, fig.width=6, fig.height=8,fig.cap="Densities of Stock/BMSY from different methods for estimating uncertainty."}
...
# Simulation
```{runcertaintyJackknife2,,eval=FALSE,fig.height=4,fig.margin=TRUE,eval=FALSE}
...
```{rMCkobe,eval=FALSE,fig.margin=TRUE,fig.width=6,fig.height=6}
